...
<template>
    <section
        class="relative w-full overflow-hidden flex flex-col justify-end"
    ...
    >
        ...
        <div class="relative z-10 px-6 lg:px-10 pb-6 lg:pb-10">
            ...
            <h1
                ...
                class="text-white font-normal leading-tight mb-1"
                :class="isEditorCanvas ? 'text-2xl' : 'text-4xl lg:text-6xl'"
                style="font-family: var(--font-display)"
            >
                {{ props.props.title }}
            </h1>
            <p v-if="props.props.subtitle" class="text-white/85" :class="isEditorCanvas ? 'text-xs' : 'text-base lg:text-lg'">

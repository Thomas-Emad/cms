...
<template>
    <div class="kiosk-root min-h-screen flex flex-col bg-white text-slate-900"
        ...
        <header class="fixed top-0 inset-x-0 z-50 flex items-center justify-between px-6 lg:px-10 text-white backdrop-blur-md"
            ...
            <div class="flex items-center gap-4 lg:gap-6">
                ...
                <Link v-if="!onHome" href="/"
                    class="flex items-center gap-1.5 h-9 px-5 rounded-full border border-white/25 bg-white/10 text-base uppercase tracking-wider transition-transform duration-150 active:scale-95">
